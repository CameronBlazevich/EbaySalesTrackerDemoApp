...
namespace EbaySalesTrackerTests
{
    ...
    public class InventoryRepositoryTests
    {
        ...
        public void CalculateAverageSalesPriceAndProfit_Successful()
        {
            ...
            listingsRepo.Setup(x => x.GetListingsByInventoryItem(userId,itemId)).Returns(listings.Where(y => y.InventoryItemId == itemId && y.TotalNetFees > 0 && y.QuantitySold > 0).ToList());

            //Act
            var testListings = listingsRepo.Object.GetListingsByInventoryItem("1", itemId);
        ...
        public void CalculateQuantitySold_Successful()
        {
            ...
            //Act
            var testListings = listingsRepo.Object.GetListingsByInventoryItem(userId,itemId);
